...
def run():
    ...
    while True:
        ...
        t1 = t + 'abc.jpg'       
        # 업로드할 이미지 파일 경로
        image_file_path = '/home/air-020/_SEND/M1907.jpg'  # 실제 파일 경로로변경해야 합니다.
        

        # 업로드할 URL (메인 컴퓨터의 Flask API 엔드포인트)
        upload_url = 'http://202.31.101.253:1907/upload'  # 메인 컴퓨터의 IP 주소로 변경해야 합니다.
